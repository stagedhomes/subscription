<?php
  ...
  require_once($_SERVER["DOCUMENT_ROOT"] . "/assets/app_modules/authentication/Session.class.php");
  require_once($_SERVER["DOCUMENT_ROOT"] . "/assets/connections/paths.config.php");
